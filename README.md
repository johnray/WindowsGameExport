...
5. **Change Tracking:** Compares existing `.bat` file contents to detect changes (no state file needed)
...
The `REM [WindowsGameExport]` signature identifies files generated by this utility. Only files with this signature will be removed during orphan cleanup.
